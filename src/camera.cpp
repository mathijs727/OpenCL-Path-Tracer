...
void raytracer::Camera::get_frustum(glm::vec3& eye, glm::vec3& scr_base_origin, glm::vec3& scr_base_u, glm::vec3& scr_base_v) const {
	...
	glm::mat4 transform_matrix = transform.matrix();
	...
	scr_base_u = glm::mat3_cast(transform.orientation) * glm::vec3(width,0,0);
	scr_base_v = glm::mat3_cast(transform.orientation) * glm::vec3(0,-height,0);
}
