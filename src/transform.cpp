...
glm::mat4 Transform::matrix() const
{
	...
	auto result = translationMatrix * orientationMatrix * scaleMatrix;
	return result;
}

glm::mat4 Transform::rayMatrix() const
{
    glm::mat4 scale_matrix = glm::scale(glm::mat4(1.0f), 1.0f / scale);
    glm::mat4 orientation_matrix = glm::mat4_cast(-orientation);
    glm::mat4 location_matrix = glm::translate(glm::mat4(1.0f), -location);
